...
var BuildOptionNormalizer = {
  normalize: function(buildOpts, query) {
    ...
    if (
      (!config.network && !Logger.error("The 'network' property is not specified in the Truffle config")) ||
      ((!config.networks || !networksList.length) && !Logger.error("The 'networks' property is not provided in the Truffle config")) ||
