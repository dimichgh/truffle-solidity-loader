...
var BuildOptionNormalizer = {
  normalize: function(buildOpts, query) {
    ...
    // define the contracts_build_directory if not done so already (default: build/contracts, http://truffleframework.com/docs/advanced/configuration#contracts_build_directory)
